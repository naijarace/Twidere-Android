...
import org.mariotaku.twidere.data.sq_lite.App;
import org.mariotaku.twidere.data.sq_lite.HomeDataSource;
import org.mariotaku.twidere.data.sq_lite.HomeSQLiteHelper;
import org.mariotaku.twidere.data.sq_lite.AppSettings;
import org.mariotaku.twidere.KeyProperties;
import org.mariotaku.twidere.data.sq_lite.HandleScrollService;
import org.mariotaku.twidere.data.sq_lite.IOUtils;
import org.mariotaku.twidere.data.sq_lite.Utils;
import org.mariotaku.twidere.data.sq_lite.WearableUtils;
        ...
        if (message.equals(KeyProperties.GET_DATA_MESSAGE)) {
            ...
            markReadHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    sendBroadcast(new Intent("org.mariotaku.twidere.CLEAR_PULL_UNREAD"));

                    final SharedPreferences sharedPrefs = getSharedPreferences("org.mariotaku.twidere_world_preferences",
                            0);
